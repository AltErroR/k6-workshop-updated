...
export class StoreService extends BaseRequestsService {
    ...
    getOrder(id: string, params?: Params) {
        return this.get(`/v2/store/order/${id}`, { ...params, requestName: 'GET /v2/store/order/{id}' })
    }

    placeOrder(body: RequestBody, params?: Params) {
        return this.post(`/v2/store/order`, body, { ...params, tags: { ...params?.tags, name: 'POST /v2/store/order' } })
    }

    deleteOrder(id: string, params?: Params) {
        return this.delete(`/v2/store/order/${id}`, null, params)//fallback option here
    }
